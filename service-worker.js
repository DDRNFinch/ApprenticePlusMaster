const CACHE='apprentice-plus-v1.6.11-remove-apprentice-pass-scanner';
...
const APP_SHELL=['./','./index.html','./styles.css?v=1.6.11','./functional-skills-bank.js?v=1.5.20','./trade-courses-bank.js?v=1.5.20','./analytics-foundation.js?v=1.5.64','./analytics-integration.js?v=1.5.64','./app.js?v=1.6.11','./release-notes.json','./technical-drawing-viewer.html','./cadmate.html','./manifest.json','./pdf-generator.js?v=1.5.20','./logo-apprentice-plus.png','./icon-192.png','./icon-512.png','./icon-1024.png','./apple-touch-icon.png','./favicon-32.png','./favicon-64.png'];
