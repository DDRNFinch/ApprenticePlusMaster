const CACHE='apprentice-plus-v1.5.16-full-app-tint-overlay';
const UPDATE_INFO={
 version:'V1.5.16',
 features:[
...
const APP_SHELL=['./','./index.html','./styles.css?v=1.5.16','./functional-skills-bank.js?v=1.5.16','./trade-courses-bank.js?v=1.5.16','./app.js?v=1.5.16','./manifest.json','./pdf-generator.js?v=1.5.16','./logo-apprentice-plus.png','./icon-192.png','./icon-512.png','./icon-1024.png','./apple-touch-icon.png','./favicon-32.png','./favicon-64.png'];
