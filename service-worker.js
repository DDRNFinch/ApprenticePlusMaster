const CACHE='apprentice-plus-v1.5.63-analytics-event-cleanup';
const CURRENT_VERSION='V1.5.63';
...
const APP_SHELL=['./','./index.html','./styles.css?v=1.5.63','./functional-skills-bank.js?v=1.5.20','./trade-courses-bank.js?v=1.5.20','./analytics-foundation.js?v=1.5.63','./analytics-integration.js?v=1.5.63','./app.js?v=1.5.63','./release-notes.json','./manifest.json','./pdf-generator.js?v=1.5.20','./logo-apprentice-plus.png','./icon-192.png','./icon-512.png','./icon-1024.png','./apple-touch-icon.png','./favicon-32.png','./favicon-64.png'];
